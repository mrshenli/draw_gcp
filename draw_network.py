...
plot_network(nnode=4, show=True)
...
fsdp = [
  [125,   350,   760,   1300,  2700,  6700,   13000,  39000,  76000],  # model size
  [0.16,  0.28,  0.28,  0.31,  0.41,  0.71,   0.00,   21.40,  75.89],  # bs=8
  [1676,  3554,  4768,  6509,  10775, 16673,  0000,   19872,  3736], 
  ["no",  "no",  "no",  "no",  "no",  "no",   "cppo", "olpo", "olpo"],
...
pdp = [
  ...
  [INF,   INF,   4.49,  9.27,   11.96,  INF,    INF,    INF,    INF],  # bs=256 (pdp bs=512)
  [INF,   INF,   32873, 30884,  33980,  INF,    INF,    INF,    INF],
  ["cp",  "cp",  "cp4", "cp16", "cp16", "",     "",     "",     ""],
]


plot_network(nnode=1, show=True)
