...
fsdp = [
  [125,   350,   760,   1300,  2700,  6700,  13000,  39000,  76000],  # model size
  [0.45,  1.19,  2.14,  4.04,  7.01,  16.10, 44.02,  116.36, 313.69], # bs=8
  [1676,  3570,  4768,  6510,  10772, 16673, 33291,  21383,  3736],   # mem
  ["no",  "no",  "no",  "no",  "no",  "no",  "no",   "cp",   "olpo"], # config
  [0.46,  1.16,  2.01,  4.25,  7.05,  19.13, 52.83,  112.48, 297.81],    # bs=16
  [3109,  6711,  8721,  11908, 19546, 28764, 12191,  20678,  4948],
  ["no",  "no",  "no",  "no",  "no",  "no",  "cp",   "ol",   "olpo"], 
  [0.49,  1.31,  2.18,  4.26,  8.96,  25.49, 56.25,  118.36, 350.4],    # bs=32
  [5990,  12999, 16735, 22756, 37219, 8535,  15880,  22777,  7372],
  ["no",  "no",  "no",  "no",  "no",  "cp",  "cp",   "ol",   "olpo"], 
  ...
  [0.97,  2.45,  4.07,  9.23,  13.62, 41.06, 86.33,  INF,    INF],    # bs=256
  [14896, 17219, 19352, 22068, 29185, 25809, 27326,  INF,    INF],
...
fsdp = [
  [125,   350,   760,   1300,  2700,  6700,   13000,  39000,  76000],  # model size
  [0.16,  0.28,  0.28,  0.31,  0.41,  0.71,   9.97,   21.40,  75.89],  # bs=8
  [1676,  3554,  4768,  6509,  10775, 16673,  33302,   19872,  3736], 
  ["no",  "no",  "no",  "no",  "no",  "no",   "nopo", "olpo", "olpo"],
  [0.17,  0.28,  0.28,  0.43,  0.58,  1.42,   8.81,   26.01,  75.88],  # bs=16
  [3109,  6696,  8721,  11907, 19547, 6212,   12182,  20679,  4948], 
  ["no",  "no",  "no",  "no",  "no",  "cp",   "cppo", "olpo", "olpo"], 
  [0.15,  0.28,  0.38,  0.72,  1.27,  2.47,   12.36,  34.76,  84.60],  # bs=32
  [5990,  12984, 16735, 22756, 5001,  8533,   15870,  22777,  7372], 
  ["no",  "no",  "no",  "no",  "cp",  "cp",   "cppo", "olpo", "olpo"],
  [0.19,  0.43,  0.63,  1.76,  2.27,  4.50,   21.48,  50.27,  108.14], # bs=64
  [11751, 25566, 32757, 6244,  8414,  13380,  15227,  27286,  13055], 
  ["no",  "no",  "no",  "cp",  "cp",  "cp",   "olpo", "olpo", "olpo"], 
  [0.32,  0.98,  1.53,  3.33,  4.30,  11.24,  38.66,  97.71,  159.68], # bs=128
  [23275, 8823,  10032, 11432, 15339, 14750,  21958,  36308,  24426],
  ["no",  "cp",  "cp",  "cp",  "cp",  "ol",   "olpo", "olpo", "olpo"],
  [0.72,  1.85,  2.92,  6.52,  9.72,  31.33,  INF,    INF,   INF],    # bs = 256
  [14896, 17219, 19352, 22069, 29185, 25809,  INF,    INF,   INF],
  ["no",  "cp",  "cp",  "cp",  "cp",  "olpo", "",     "",     ""],
]
...
pdp = [
  [125,   350,   760,   1300,   2700,   6700,   13000,  39000,  76000],  # model size
  [0.11,  0.19,  0.20,  0.32,   0.44,   0.86,   INF,    INF,    INF], # bs=8 (pdp bs=16)
  [2131,  3721,  5518,  8051,   13858,  27973,  INF,    INF,    INF],
  ["no",  "no",  "no",  "no",   "no",   "no",   "",     "",     ""],
  [0.12,  0.23,  0.32,  0.61,   0.79,   1.46,   INF,    INF,    INF],  # bs=16 (pdp bs=32)
  [3679,  6120,  8330,  11588,  19114,  28417,  INF,    INF,    INF],
  ["no",  "no",  "no",  "no",   "no",   "no4",  "",     "",     ""],
  [0.17,  0.36,  0.55,  1.12,   1.37,   2.66,   INF,    INF,    INF],  # bs=32 (pdp bs=64)
  [6761,  10920, 14004, 18686,  15150,  23869,  INF,    INF,    INF],
  ["no",  "no",  "no",  "no",   "no8",  "cp8",  "",     "",     ""],
  [0.29,  0.66,  1.01,  2.11,   2.53,   4.98,   INF,    INF,    INF], # bs=64 (pdp bs=128)
  [12945, 20522, 25350, 32828,  21698,  37628,  INF,    INF,    INF],
  ["no",  "no",  "no",  "no",   "no8",  "no8",  "",     "",     ""],
  [0.53,  1.16,  1.79,  3.73,   4.85,   12.09,  INF,    INF,    INF], # bs=128 (pdp bs=256)
  [25313, 26600, 22974, 27048,  36646,  30305,  INF,    INF,    INF],
  ["no",  "no",  "no8", "no8",  "no8",  "cp16", "",     "",     ""],
  [0.97,  2.82,  4.49,  9.27,   11.96,  INF,    INF,    INF,    INF],  # bs=256 (pdp bs=512)
  [38230, 31444, 32873, 30884,  33980,  INF,    INF,    INF,    INF],
  ["no4", "cp4", "cp4", "cp16", "cp16", "",     "",     "",     ""],
]


plot_network(nnode=1, show=False)
